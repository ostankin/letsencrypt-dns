...
function deploy_challenge {
    ...
    lexicon --delegated="${DOMAIN}" $PROVIDER create "${DELEGATION_MASTER_DOMAIN}" TXT --name="_acme-challenge.${DOMAIN}." --content="${TOKEN_VALUE}"
...
function clean_challenge {
    ...
    lexicon --delegated="${DOMAIN}" $PROVIDER delete "${DELEGATION_MASTER_DOMAIN}" TXT --name="_acme-challenge.${DOMAIN}." --content="${TOKEN_VALUE}"
